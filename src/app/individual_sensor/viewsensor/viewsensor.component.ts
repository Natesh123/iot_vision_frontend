...
@Component({
  selector: 'ngx-viewsensor',
  templateUrl: './viewsensor.component.html',
  styleUrls: ['./viewsensor.component.scss']
})
export class ViewsensorComponent implements OnInit {
  ...
  getDeviceData(){
    ...
    this.authenticationService.getDeviceData(json).then((result)=>{
      console.log(result); 
